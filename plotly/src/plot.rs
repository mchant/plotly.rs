...
mod tests {
    ...
    fn test_image_to_base64() {
        ...
        assert_eq!(expected, image_base64);
    }
    ...
    fn test_image_to_svg_string() {
        ...
        // Limit the test to the first 250 charcters to avoid comparing the non-unique
        // element ids
        const LEN_LIMIT: usize = 250;
        assert_eq!(expected[..LEN_LIMIT], image_svg[..LEN_LIMIT]);
    }
}
